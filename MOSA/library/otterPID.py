...
if __name__ == "__main__": 
    ...
    for i in range(4000):
        ...
        time1=time.time()
        output=los2.execute(nu,current_eta,Wpx,Wpy)
        ...
        # los2.los_simulation(current_eta,Wpx,Wpy,u_control) # plotting animation
        los2.los_simulation(current_eta,Wpx,Wpy,u_control)
        # los2.animate(current_eta,Wpx,Wpy,u_control,i)
        



        if los2.x_los==los2.x_closest and los2.y_los == los2.y_closest:
            print('xxxxxxxxx') 
            break 
